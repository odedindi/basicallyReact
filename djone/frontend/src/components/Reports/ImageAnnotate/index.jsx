  ...
  constructor(props) {
    ...
    this.props.dispatch({
      ...
      payload: {
        ...
        activeAnnotations: this.props.annotationsToReport.KARTEUMGEBUNG ? this.props.annotationsToReport.KARTEUMGEBUNG.activeAnnotations :  [],
        annotations: this.props.annotationsToReport.KARTEUMGEBUNG ? this.props.annotationsToReport.KARTEUMGEBUNG.annotations : [],
        annotation: {},
    ...
    this.props.dispatch({
      ...
      payload: {
        ...this.props.karteUW,
        type: PointSelector.TYPE,
        activeAnnotations: this.props.annotationsToReport.KARTEUW ? this.props.annotationsToReport.KARTEUW.activeAnnotations : [],
        annotations: this.props.annotationsToReport.KARTEUW ? this.props.annotationsToReport.KARTEUW.annotations : [],
        annotation: {},
  ...
  render () {
    ...
    return (
      <>
        ...
        {
          this.state.toggleImage ?  <Annotator key='1' data={ this.props.karteUmgebung }/> 
            : <Annotator key='2' data={ this.props.karteUW }/>
        }
      </>
    )
  }
